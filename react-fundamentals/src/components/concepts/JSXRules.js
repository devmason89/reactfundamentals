...
const CreateElementComponent = () => {
    return(
        ...
        React.createElement('img', {src: 'http://milosristic.com/wp-content/uploads/2018/08/rsz_32.png'}, null)

    )
}

//first set of curly braces is React letting us interpolate. use whenever we want to write JS that React can interpret. second set of curly braces are for style object we define

//good to know that our JSX code is just JavaScript behind the scenes